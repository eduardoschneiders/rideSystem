...
class Util{
  ...
  public function clearString($string){
    ...
    $str = str_replace(array_keys($invalid), array_values($invalid), $string);

    return $str;
  }

  public function firstWord($phrase = NULL){

    $explodedPhrase = explode(' ', $phrase);

    return $explodedPhrase[0];
